            ...
            <Form className="register-form" onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <Form.Group className="mb-3" controlId="formBasicRadio">
                  <Form.Check
                    ...
                    label="Email"
                    value="Email"
                    checked={formData.prefMethodOfContact === "Email"}
                    onChange={handleChange}
                  />
                  <Form.Check
                    inline
                    ...
                    label="WhatsApp"
                    value="Whatsapp"
                    checked={formData.prefMethodOfContact === "Whatsapp"}
                    onChange={handleChange}
                  />
                  <Form.Check
                    inline
                    ...
                    label="SMS Text"
                    value="Message"
                    checked={formData.prefMethodOfContact === "Message"}
                    onChange={handleChange}
                  />
                </Form.Group>
              </div>
              ...
              <Form.Group>
                ...
                <Form.Text className="text-muted">
                  ...
                  what Jain community are they related with in India and be very
                  specific
                </Form.Text>
              </Form.Group>
              {process.env.SHOW_COMMUNITY_PROOF ? (
                <Form.Group controlId="formFile" className="mb-3">
                  ...
                  />
                  <Form.Text className="text-muted">
                    This is a certificate that shows you are a Jain. If you are
                    not aware of this please ask your parents. Your application
                    will be rejected if you don’t upload an appropriate
                    document.
                  </Form.Text>
                </Form.Group>
              ) : (
