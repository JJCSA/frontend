          ...
          <fieldset className="fieldsetstyle">
            ...
            <div className="form-row col-sm-12">
              ...
              <div className="col-sm-12">
                ...
                <input
                  type="email"
                  className="form-control form-input input-sm w-50"
              ...
              <label class="label" forHTML="call"  style = {{"font-size":"12px"}} >Phone Call</label>
              </div>
              <div className="form-check col-sm-6">
              <input type="checkbox" class="form-check-input" name="premail" />
              <label class="label " style = {{"font-size":"12px"}} forHTML="premail">Email</label>
              </div>
              </div>
              <div className="form-row col-sm-12 ml-2">
              <div className="form-check col-sm-6">
              <input type="checkbox" class="form-check-input" name="whatsapp" />
              <label class="label"  style = {{"font-size":"12px"}} forHTML="call">Whatsapp</label>
              </div>
              <div className="form-check col-sm-6">
              <input type="checkbox" class="form-check-input" name="sms" />
              <label class="label"   style = {{"font-size":"12px"}} forHTML="call">SMS Text</label>
              </div>
              </div>
              </div>
              </div>
...
Your application will be rejected if you don’t upload an appropriate document.</label>
          ...
          <div className="col-sm-12">
            ...
            />
              ...
              <button
              type = "button"
              className="btn btn-md btn-block btnSignUp w-75 label ml-5 mt-3">
              Submit
              </button>
