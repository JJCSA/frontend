...
const TermAndCondition = () => {
    return (
        <Container fluid className="TermAndCondition-container">
            <Row>
                <div className='TermAndConditionimage'>

                </div>
            </Row>
            <Row>
                <Col className="TermAndCondition-text">
                    <div className='TermAndConditionPage'>
                        <div id="Term-And-Condition" className="TermAndCondition">
