  ...
  return (
    <div className="TERMSANDCONDITIONS">
      ...
      <Container fluid className="terms-conditions-container">
        <Row>
          <Col className="terms-conditions-text">
            <div className="terms-conditions-page">
              <div id="terms-conditions" className="terms-conditions">
                ...
                <p>
                  ...
                  images, audio clips, and software, are the property of JJC USA
                  or its licensors. You are prohibited from reproducing,
                  distributing, modifying, or using any content from the Website
                  without explicit permission from JJC USA.
                </p>
                ...
                <p>
                  ...
                  You are solely responsible for any information or content you
                  submit or transmit through the Website.
                </p>
                <h4> 3. User Representation </h4>
                <ul>
                  <li>
                    ...
                    <ol>
                      ...
                      <li>
                        You have the legal capacity and agree to comply with
                        these Terms of Use.
                      </li>
                      <li>
                ...
                <p>
                  ...
                  display content from third parties. These links and content
                  are provided for your convenience and do not imply endorsement
                  by JJC USA. JJC USA does not control or assume any
                  responsibility for the accuracy, legality, or availability of
                  such third-party websites or content. Your use of third-party
                ...
                <h4>10. Modification and Termination</h4>
                <p>
                  JJC USA reserves the right to modify, suspend, or terminate
                  the Website or any part of it at any time without prior
                  notice. JJC USA may also update these Terms and Conditions
                  from time to time without notice. Your continued use of the
                ...
                Privacy Policy: https://www.jjcusa.org/PrivacyPolicy. By using
                ...
                to the United States, and you agree to have your data
                transferred to and processed in the United States.
                <h4>13. Governing Law and Jurisdiction</h4>
                <p>
                  These Terms and Conditions shall be governed by and construed
                  in accordance with the laws of the state of [State], United
                  States. Any disputes arising from or relating to these Terms
                  and Conditions or your use of the Website shall be subject to
                  the exclusive jurisdiction of the courts located in [County],
                  [State], United States.
                </p>
                ...
                <p>
                  ...
                  the state and federal courts located in Queens, New York, and
                ...
                <p>
                  ...
                  in any way to the Site be commenced more than two (2) years
                ...
                <h4>20. California Users and Residents</h4>
                <p>
                ...
                <p>
                  ...
                  and JJC USA regarding the use of the Website and supersedes
                ...
                <p>
                  ...
                  Conditions before using the JJC USA Website. If you have any
                  questions or concerns, please contact JJC USA for
                  clarification.{' '}
                  <a
                ...
                <p className="terms-conditions-date">
